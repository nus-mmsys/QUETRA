...
Iaa<-barplot(Ia, width = 5, space =0.5, beside=TRUE , main=paste("Profile:",j+1," Metric: Inefficiency", "\n","Buffer: 30/60 "), density = 100 ,ylim=c(0,1), ylab="Inefficiency", font.lab = 2,axisnames=Ia,col=brewer.pal(9, "Set1")) 
arrows(Iaa, minIa, Iaa,
       maxIa, lwd = 1.5, angle = 90,
       code = 3, length = 0.05)

#par(mar = c(4, 1, 4, 1))
IIaa<-barplot(IIa, width = 5, space =0.5, beside=TRUE , main=paste("Profile:",j+1," Metric: Inefficiency", "\n","Buffer: 120"), density = 100 ,ylim=c(0,1), ylab="Inefficiency",font.lab = 2, axisnames=IIa,col=brewer.pal(9, "Set1")) 
arrows(IIaa, minIIa, IIaa,
       maxIIa, lwd = 1.5, angle = 90,
       code = 3, length = 0.05)

#par(mar = c(4, 1, 4, 1) + 0.4)
IIIaa<-barplot(IIIa, width = 5, space =0.5, beside=TRUE , main=paste("Profile:",j+1," Metric: Inefficiency", "\n","Buffer: 240 "), density = 100 ,ylim=c(0,1), ylab="Inefficiency",font.lab = 2, axisnames=IIIa,col=brewer.pal(9, "Set1")) 
